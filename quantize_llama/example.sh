...
# python -m quantize_llama.hessian_offline_llama --batch_size 4 --devset_size 256 --ctx_size 2048 --base_model meta-llama/Llama-2-7b-hf --save_path $HESS/llama2_7b_256
...
# python -m quantize_llama.quantize_finetune_llama --save_path $CKPT/2_7b_2bit --codebook E8P12  --scale_override 0.9 --base_model meta-llama/Llama-2-7b-hf  --hessian_path $HESS/llama2_7b_256/ --devset_size 384 --ft_valid_size 128 >> $LOG/2_7b_2bit 2>&1
...
python -m quantize_llama.finetune_e2e_llama --base_model meta-llama/Llama-2-7b-hf --hf_path $HF/2_7b_2bit --devset_size 256 --ft_valid_size 128 --ft_epochs 8  --ft_bs 1 --ctx_size 4096 --ft_update_freq 2 --ft_train_mode --ckpt_path $CKPT/2_7b_2bit --batch_size 4 #>> $LOG/2_7b_2bit 2>&1
